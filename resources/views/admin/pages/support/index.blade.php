...
@endif
    ...
    <div class="page_header" style="display: flex; align-items: center;justify-content: space-between;">
        <h2>Sopport List</h2>
        <a href="javascript:void(0)" data-toggle="modal" data-target="#myModal" class="btn btn-md btn-success">Add Support</a>
    </div>
                ...
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('support.destroy', $item->id) }}"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h3 class="modal-title" id="myModalLabel">Update Support </h3>
                                </div>
                                <div class="modal-body">
                                    <form action="{{ route('support.update', $item) }}" method="post">
                                        @csrf
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                    <h3 class="modal-title" id="myModalLabel">Add New Support</h3>
                </div>
                <div class="modal-body">
