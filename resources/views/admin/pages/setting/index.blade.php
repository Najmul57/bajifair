        ...
        <form action="{{ route('setting.update', $data->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div style="display: flex; gap: 10px;">
                ...
                <div class="logo" style="border-radius: 10px">
                    ...
                    <img id="logoPreview" src="{{ asset('upload/logo/' . $data->logo) }}" alt="Logo" style="width: 200px; border-radius: 10px;">
                ...
                <div class="favicon" style="border-radius: 10px">
                    ...
                    <img id="faviconPreview" src="{{ asset('upload/favicon/' . $data->favicon) }}" alt="Favicon" style="width: 80px; border-radius: 10px;">
