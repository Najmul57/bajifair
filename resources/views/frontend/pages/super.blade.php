                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-bordered ">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                <td><span style="font-size: 15px;position: relative; left: 0; right: 0; margin: auto;">ID {{$super->admin_id }}</span></td>
                                <td>
                                    <a href="https://wa.me/+{{$super->whatsapp }}" title="WhatsApp : +{{$super->whatsapp }}"
